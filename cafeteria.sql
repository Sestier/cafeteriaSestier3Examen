...
--
-- Servidor: localhost
-- Tiempo de generación: 10-05-2018 a las 00:39:09
...
(1, 1, 1, 'Orden de burritos', 22, 5, 110),
(2, 2, 2, 'Molletes', 40, 4, 160),
(3, 2, 1, 'Orden de burritos', 22, 2, 44);
...
(1, 3, 1, '2018-05-09 16:28:18', 110),
(2, 3, 1, '2018-05-09 17:10:45', 204);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pedidosCocinero`
--

CREATE TABLE `pedidosCocinero` (
  `id` int(11) NOT NULL,
  `idUsuario` int(11) NOT NULL,
  `idElementosPedido` int(11) NOT NULL,
...
(1, 1, 'Emiliano', 'emiliano@correo.com', '$2y$10$kxEHxdfcAxboShoKaMfsCuRq0pK/Wrc9WdQ4buPlL4et1KAD.iBDu', 'j5HDFTK8uQrwHs8gv4uKyLWlojfiCqOWUugpGcps1gjQpaTzxZVMEzGWllU0', '2018-03-01 06:36:30', '2018-05-10 07:14:00'),
...
(3, 2, NULL, 'cliente@correo.com', '$2y$10$ZLF1Bt6/Wy.iGS4r2/EwQe0FF2LBTbT.oJX6RYq1gmrgqC0U4s56a', 'GPmgoSP2GWcwFGbWWUICuWMOFO0DwPMImu2mhFvzl1392lpE5dLjaHlKxqck', '2018-04-19 07:15:10', '2018-05-10 07:13:40'),
...
(5, 3, NULL, 'cocinero@correo.com', '$2y$10$ELqKioOORIkDtvWOwj8UIuPmEYsWcK4G/QuVP0UTQ2gVKAwzxo.oG', 'Mrhi7UKq74qJlNejsHBSNnNWePs5tl0Ni4NRIYhSKHZSGz3H8iJ3pPyGbPHL', '2018-05-10 05:54:24', '2018-05-10 07:09:55');
...
--
-- Indices de la tabla `pedidosCocinero`
--
ALTER TABLE `pedidosCocinero`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `pedidosCocinero`
--
ALTER TABLE `pedidosCocinero`
